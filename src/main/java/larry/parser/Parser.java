...
public class Parser {
    ...
    private static EditCommand parseEditCommand(String command) throws LarryException {
        ...
        if (parts.length < 3 || parts[2].isBlank()) {
            throw new LarryException("ERROR: The edit replacement value cannot be blank.");
        }
    ...
    private static void validateEditDateTime(EditField field, String replacementValue)
        ...
        try {
            ...
            throw new LarryException("ERROR: The value for " + field.getMarker()
    ...
    private static LarryException invalidEditSyntax() {
        return new LarryException("ERROR: Use edit INDEX /description DESCRIPTION, "
    ...
    private static Event parseEvent(String command) throws LarryException {
        ...
        try {
            ...
            throw new LarryException(EditCommand.INVALID_EVENT_ORDER_MESSAGE);
        }
    }
